...
public:
  explicit ConfigProxy(bool is_daemon): config{values, obs_mgr, is_daemon} {}
  ...
  int set_val(const std::string& key, const std::string& s, std::stringstream* err_ss=nullptr) {
    std::lock_guard l{lock};
